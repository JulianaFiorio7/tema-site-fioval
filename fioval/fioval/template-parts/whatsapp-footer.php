...
<div class="wa__popup_chat_box">
    <div class="wa__popup_heading">
        ...
        <div class="wa__popup_intro">Olá! Clique no atendente para começar o atendimento <strong>Whatsapp</strong></a></div>
    </div>
    <div class="wa__popup_content wa__popup_content_left">
        <div class="wa__popup_notice">A equipe normalmente responde em poucos minutos.</div>
        <div class="wa__popup_content_list">
            <div class="wa__popup_content_item ">
				<a target="_blank" href="<?= get_field('url_whatsapp', 11) ?>" class="wa__stt wa__stt_online">
